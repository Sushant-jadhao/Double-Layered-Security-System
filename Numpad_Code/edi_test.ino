...
const char* ssid = "free_ka_nahi_hai";
const char* password = "12341234";

uint8_t connection_state = 0;
uint16_t reconnect_interval = 10000;

EMailSender emailSend("sushant.jadhao21@vit.edu", "Sushant@123");
...
void mail(){
    ...
    EMailSender::Response resp = emailSend.send("hrutuja.mirgal21@vit.edu", message);
